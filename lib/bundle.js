	...
	var Menu = function () {
	  ...
	  _createClass(Menu, [{
	    ...
	    value: function click(e) {
	      if (e.screenX > 121 && e.screenX < 350) {
	        if (e.screenY > 258 && e.screenY < 282) {
	          window.clearInterval(this.drawMenu);
	          this.playSong(0);
	        }
	        if (e.screenY > 306 && e.screenY < 336) {
	          window.clearInterval(this.drawMenu);
	          this.playSong(1);
	        }
	        if (e.screenY > 357 && e.screenY < 384) {
	          window.clearInterval(this.drawMenu);
	          this.playSong(2);
	        }
	      }
	    ...
	    value: function playSong(selected) {
	      ...
	      if (selected === 1) {
	        var _song = new _song4.default('assets/medium.mp3', 88, 200, 2725, 100, text, 255, 10.85);
	        var _game = new _game4.default(_song, 'assets/medium.jpg');
	        _game.start();
	      }
	      if (selected === 2) {
	        var _song2 = new _song4.default('assets/hard.mp3', 120, 300, 5750, 100, text, 480, 13.23);
