	...
	var Menu = function () {
	  ...
	  _createClass(Menu, [{
	    ...
	    value: function playSong(selected) {
	      ...
	      if (selected === 1) {
	        var _song = new _song4.default('http://res.cloudinary.com/loudsounds/video/upload/v1473962527/medium_fppvup.mp3', 88, 200, 2700, 100, text, 255, 10.85, this.caps, this.punctuation);
	        var _game = new _game4.default(_song, 'assets/medium.jpg');
	        _game.start();
	      }
	      if (selected === 2) {
	        var _song2 = new _song4.default('http://res.cloudinary.com/loudsounds/video/upload/v1473997490/First_Day_v9rzak.mp3', 95, 250, 2300, 100, text, 352, 7.75, this.caps, this.punctuation);
	    ...
	    value: function draw() {
	      ...
	      baseImage.onload = function () {
	        ...
	        if (time < _this2.song.timeOffset - 12 * _this2.song.secondsPerBeat) {
	          _this2.ctx.fillText("Get Ready To Type!", 300, 500);
	        } else if (time < _this2.song.timeOffset - 8 * _this2.song.secondsPerBeat) {
	          _this2.ctx.fillText("3...", 350, 500);
	        } else if (time < _this2.song.timeOffset - 4 * _this2.song.secondsPerBeat) {
	          _this2.ctx.fillText("2...", 350, 500);
	        } else if (time < _this2.song.timeOffset) {
	          _this2.ctx.fillText("1...", 350, 500);
	        } else if (time > _this2.song.timeOffset) {
	          _this2.ctx.fillText("", 350, 500);
	        }
	        var progress = 0;
	        if (time > _this2.song.timeOffset) {
	          progress = (time - _this2.song.timeOffset) / (_this2.song.time - _this2.song.timeOffset);
	        }
	        _this2.ctx.fillStyle = "lightgrey";
	        _this2.ctx.fillRect(0, 575, progress * 1000, 25);
	        _this2.ctx.fillStyle = "darkgrey";
	        _this2.ctx.fillRect(0 + progress * 1000, 575, 1000 - progress * 1000, 25);
	      };
	...
	var Song = function () {
	  ...
	  _createClass(Song, [{
	    ...
	    value: function startScroll() {
	      ...
	      var constant = Math.ceil(this.bpm / 60);
	      this.hAdjustInterval = window.setInterval(function () {
	        _this2.hAdjust += constant;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Gameover = function () {
	  ...
	  _createClass(Gameover, [{
	    ...
	    key: 'click',
	    value: function click(e) {
	      if (e.clientX > 400 + this.xMargin && e.clientX < 505 + this.xMargin) {
	        if (e.clientY > 160 && e.clientY < 205) {
	          this.retry();
	        }
	        if (e.clientY > 260 && e.clientY < 305) {
	          this.goToMenu();
	        }
	      }
	    }
	    ...
	    value: function hover(e) {
	      if (e.clientX > 400 + this.xMargin && e.clientX < 505 + this.xMargin) {
	        ...
	        if (e.clientY > 260 && e.clientY < 306) {
	          this.selected = 1;
	        }
	      }
	    }
	    ...
	    value: function draw() {
	      ...
	      baseImage.onload = function () {
	        ...
	        _this2.ctx.fillText("Menu", 400, 300);
	      };
	      baseImage.src = this.background;
	    }
	  }]);
