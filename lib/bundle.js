	...
	var Menu = function () {
	  ...
	  _createClass(Menu, [{
	    ...
	    value: function playSong(selected) {
	      ...
	      if (selected === 0) {
	        var song = new _song4.default('http://res.cloudinary.com/loudsounds/video/upload/v1473962530/easy_c6pnms.mp3', 95, 120, 3185, 100, text, 144, 20.345);
	        var game = new _game4.default(song, 'assets/easy.jpg');
	        game.start();
	      }
	      if (selected === 1) {
	        var _song = new _song4.default('http://res.cloudinary.com/loudsounds/video/upload/v1473962527/medium_fppvup.mp3', 88, 200, 2725, 100, text, 255, 10.85);
	        var _game = new _game4.default(_song, 'assets/medium.jpg');
	        _game.start();
	      }
	      if (selected === 2) {
	        var _song2 = new _song4.default('http://res.cloudinary.com/loudsounds/video/upload/v1473962535/hard_xkhdjp.mp3', 100, 300, 2365, 100, text, 464, 6.55);
