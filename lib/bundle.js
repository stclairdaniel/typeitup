	...
	var Menu = function () {
	  ...
	  _createClass(Menu, [{
	    ...
	    value: function playSong() {
	      ...
	      if (this.selected === 1) {
	        var _song = new _song4.default('assets/medium.mp3', 88, 200, 2725, 100, text, 258, 10.85);
	        var _game = new _game4.default(_song, 'assets/medium.jpg');
	        _game.start();
	      }
	      if (this.selected === 2) {
	        var _song2 = new _song4.default('assets/hard.mp3', 125, 300, 5750, 100, text, 480, 13.23);
